...
class Upload extends Component {
  ...
  render() {
    const { title, videoUrl, isEditingNotes, notes, searchQuery, selectedIngredients } = this.state;
    ...
    return (
      <div className="flex-1 p-8 ">
        <input
          ...
          style={{ outline: "none", fontSize: "45px", fontWeight: "normal", position: "relative", top: "-10px" }}
        />
...
<div className="Notes border-2 rounded-lg p-10 text-center mb-6" style={{ background: "#E6CDA4", width: "35vw", height: "35vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
  {isEditingNotes ? (
    <>
      <label className='jetbrains-mono' htmlFor="notes" style={{ alignSelf: "flex-start", marginBottom: "5px", fontWeight: "light" }}>Notes</label>
      <textarea
        className='jetbrains-mono'
        value={notes}
  ...
  <ul className="list-disc pl-5 max-h-32 overflow-y-auto" style={{ marginBottom: "20px", listStyleType: "disc",marginLeft:"30px" }}>
      ...
      <li key={index} className="text-lg mb-2" >
        <div style={{ display: "inline-flex", alignItems: "center"}}>
          ...
          <img 
            src={cross} 
            alt="cross button" 
            onClick={() => this.handleDeleteIngredient(ingredient)}
            style={{ position:"absolute",right:"334px", height: "20px", cursor: "pointer" }} 
          />
        </div>
      </li>
    ))}
